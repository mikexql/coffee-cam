...
#define EI_CLASSIFIER_PROJECT_ID                 821034
#define EI_CLASSIFIER_PROJECT_OWNER              "limyeekiat"
#define EI_CLASSIFIER_PROJECT_NAME               "milk"
...
#undef EI_CLASSIFIER_ALLOCATION_HEAP
